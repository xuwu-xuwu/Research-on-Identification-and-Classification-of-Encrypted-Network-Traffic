...
SOURCE_MD = REPORTS_DIR / "详细设计报告-网络流量加密方法识别与分类技术研究.md"
TEMPLATE_DOCX = next((ROOT / "docs" / "templates" / "信息系统安全与对抗技术-报告模板").glob("*301*详细设计报告*.docx"))
OUTPUT_DOCX = REPORTS_DIR / "详细设计报告-网络流量加密方法识别与分类技术研究-模板规范版.docx"
